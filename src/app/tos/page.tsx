...
export default function TermsOfService() {
  return (
    <main className="mx-auto my-8 max-w-4xl rounded-lg p-8 font-sans shadow-md">
      <h1 className="mb-6 text-3xl font-bold">Terms of Service</h1>

      <p className="mb-6 text-sm text-gray-400">
        <strong>Updated:</strong> June 8, 2025
      </p>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          ...
          <li>Contains adult content without proper age restrictions</li>
          <li>Promotes violence, self-harm, or dangerous activities</li>
          <li>
            Invades privacy or shares personal information without consent
          </li>
          <li>Contains malware, viruses, or other harmful code</li>
        </ul>
        <p className="mb-2 font-medium">Content you post:</p>
        <ul className="mb-4 list-disc pl-6">
          <li>
            Remains your property, but you grant us a worldwide, royalty-free
            license to display, distribute, and promote it on our platform
          </li>
          <li>
      ...
      <section className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">6. Privacy and Data</h2>
        <ul className="mb-4 list-disc pl-6">
          ...
          <li>
            We retain deleted account data for 90 days, then permanently delete
            it
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>Our platform, features, design, and branding are our property</li>
          <li>
            User-generated content belongs to users, subject to the license
            granted to us
          </li>
          <li>
          ...
          <li>
            Third-party content and trademarks remain property of their
            respective owners
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            You can delete your account anytime through your account settings
          </li>
          <li>
            We may suspend or terminate accounts for violations with or without
            notice
          </li>
          <li>
            Upon termination, these terms remain in effect for applicable
            provisions
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            We may update these terms with 30 days advance notice via email or
      ...
      <section className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">11. Miscellaneous</h2>
        <ul className="mb-4 list-disc pl-6">
          <li>
            If any provision is found unenforceable, the rest of these terms
            remain in effect
          </li>
          <li>
          ...
          <li>No third parties have rights under these terms</li>
        </ul>
      </section>

      <section className="mb-6">
        <h2 className="mb-3 text-xl font-semibold">12. Contact Information</h2>
        <p className="mb-2">For questions about these terms, contact us at:</p>
        <ul className="mb-4 list-disc pl-6">
          <li>Email: wesleynw [at] pm.me</li>
        </ul>
      </section>
    </main>
  );
